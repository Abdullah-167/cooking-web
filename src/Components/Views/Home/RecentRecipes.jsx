            ...
            <div className='py-20'>
                ...
                <div className='flex gap-14 justify-between'>
                    <div>
                        {data.map((item, index) => {
                            return (
                                <div className='flex gap-6 items-center max-w-[730px] py-4' key={index}>
                                    <div className="relative overflow-hidden max-w-[500px] ">
                                        <Image className='transition-transform pb-3 hover:scale-105 duration-500' src={item.mainImg} alt={'food'} width={800} height={800} />
                                    </div>
                                    <div className='gap-7 pb-3'>
                                        ...
                                        <p className='text-2xl font-secondary pb-4'>{item.mainHeading}</p>
                    ...
                    <div className='max-w-[360px]'>
                        <div className='relative grid grid-cols-3 gap-x-7 gap-y-6 border px-8 py-14'>
                        ...
                        <div className="max-w-[350px] bg-[#F7F7F7] px-12 py-10 my-10">
                        ...
                        <div className='relative  border px-8 py-14'>
                            ...
                            <div>
                                {sidebar.map((item, index) => {
                                    return (
                                        <div className='flex gap-6 items-center max-w-[350px] py-1' key={index}>
                                            <div className="relative overflow-hidden max-w-[500px] ">
                        ...
                        <Image className='py-10 cursor-pointer' src={'/add.jpg'} alt='add' width={500} height={500} />
