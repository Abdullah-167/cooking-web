            ...
            <div className='container'>
                <div className='max-w-[470px]'>
                    <h2 className='text-[50px] font-secondary leading-[50px] relative pb-7'>
                        Check out my <span className=' relative'>  newest <span className='border-b-[3px] border-b-[#fee86d] absolute top-10 w-36 h-2 -right-[2px]'></span> </span>  vegan recipes books
                    </h2>
