    ...
    return (
        <div>
            <div className='max-w-[360px]'>
                <Image className='pt-20 pb-20' src={'/add.jpg'} alt='add-imgh' width={500} height={500} />
                ...
                <Image className='pt-20 pb-10 cursor-pointer' src={'/healthy.jpg'} alt='add-imgh' width={500} height={500} />
                <Image className='pb-20 cursor-pointer' src={'/breakfast.jpg'} alt='add-imgh' width={500} height={500} />

                <div className="max-w-[350px] bg-[#F7F7F7] px-12 py-10 mb-20">
