    ...
    return (
        <div className=' container'>
            <div>
                ...
                <p className="text-gray-400 opacity-90 pb-2" for="subscribe">
                ...
                <form className="pt-6 pb-8 mb-4 max-w-[750px]">
                    <div className="mb-4">
                        <textarea
                            ...
                            id="message" name="message" placeholder="Your Comment*"></textarea>
                    </div>
                    ...
                    <div className="flex items-center mb-4">
                        <input
                            ...
                            name="subscribe"
                        />
                        <label className="text-gray-400 opacity-90" for="subscribe">
